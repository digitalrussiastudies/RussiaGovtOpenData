(function() {
    ...
    */
    ...
    /* @ngInject */
    function MainController($scope, FacetHandler, drsOpendataService, facetUrlStateHandlerService) {
        var vm = this;
        ...
        // Get the facet configurations from drsOpendataService.
        vm.facets = drsOpendataService.getFacets();
        ...
        function getFacetOptions() {
            var options = drsOpendataService.getFacetOptions();
            options.scope = $scope;
        ...
        function updateResults(event, facetSelections) {
            ...
            // The drsOpendataService returns a (promise of a) pager object.
            return drsOpendataService.getResults(facetSelections)
            .then(function(pager) {
                if (uid === updateId) {
                    vm.pager = pager;
